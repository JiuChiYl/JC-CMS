...
import type { UserInfo } from '@jc-cms/shared'
...
const props = withDefaults(defineProps<{
  ...
  BodyColor: () => ['#FF9AC6', '#B0DDFE'],
  FooterColor: '#FFE5F9',
  footer_icon_color: '#B7B6FF',
  userInfo: () => ({
...
const user_colorCard_description_btn = ref<HTMLElement | null>(null)
const description_btn = ref<HTMLElement | null>(null)
onMounted(() => {
...
const description_btn_click = () => {
  ...
  if (!description_btn.value) return
